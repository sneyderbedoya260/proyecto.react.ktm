...
export async function obtenerUsuario(req, res) {
  const [filas] = await pool.query(
    `SELECT u.id, u.nombre, u.apellido, u.tipo_documento, u.numero_documento, u.direccion, u.telefono, u.correo, u.estado, r.nombre AS rol
...
export async function actualizarUsuario(req, res) {
  ...
  await pool.query(
    'UPDATE usuarios SET nombre = ?, apellido = ?, direccion = ?, telefono = ?, rol_id = ? WHERE id = ?',
    [nombre, apellido, direccion, telefono, rol_id, req.params.id]
  );
