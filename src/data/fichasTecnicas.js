...
//
// Para habilitar el configurador de color de un modelo, añade a su ficha una
// lista `colores: [{ nombre, hex, imagen: '/images/archivo.jpg' }, ...]` con
// una FOTO REAL por color. Si no hay varias fotos reales, no se muestra
// selector de color (no se simulan variantes).
...
// Color de fábrica por defecto (Naranja KTM). El configurador de color solo
// se muestra cuando un modelo tiene varias fotos reales en su lista `colores`,
// cada una con su propia `imagen`. Sin fotos reales de variantes, no se inventan.
export const COLOR_DEFECTO = { nombre: 'Naranja KTM', hex: '#FF6600' };
